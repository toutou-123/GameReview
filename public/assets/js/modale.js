    ...
    image.onclick = function () {
        ...
        fetch(`/game/${gameId}`)
            ...
            .then(game => {                
                ...
                document.getElementById('modal-link').innerHTML = `<a href="${game.link}" target="_blank">Voir le jeu</a>`; // Lien vers le jeu
                ...
                game.categories.forEach(category => {
                    ...
                    categoryLink.innerText = category; // Nom de la catégorie
